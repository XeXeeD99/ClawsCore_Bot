...
# Full badge milestones including intermediate badges  
badges = {  
    500: "📘 Apprentice Analyst",  
    3000: "⚔️ Strategy Wielder",  
    7000: "🔮 Chart Whisperer",  
    10000: "🧪 Tactical Alchemist",      # Intermediate badge  
    15000: "🧠 Memory Hoarder",           # Intermediate badge  
    20000: "💸 Profit Reaper",  
    50000: "🧠 Pattern Sage",  
...
async def achievements(update: Update, context: ContextTypes.DEFAULT_TYPE):  
    ...
    badge_list = "\n".join([f"{badge} — <i>{xp} XP+</i>" for xp, badge in sorted(badges.items())])  
    await update.message.reply_text(  
...
if __name__ == "__main__":  
    main()    app.add_handler(CommandHandler("profile", profile))
    app.add_handler(CommandHandler("badge", badge))
    app.add_handler(CommandHandler("achievements", achievements))
